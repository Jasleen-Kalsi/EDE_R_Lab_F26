...
#Create and print a list of all files in data raw folder using "dir" and "here"
...
files <- dir(folder, pattern = "EPAair_O3*.*", full.names = TRUE) ##data has to have same columns and same names so dataset can make sense
EPAData <- files %>%
